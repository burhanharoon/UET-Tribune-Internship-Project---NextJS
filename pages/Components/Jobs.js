...
const jobs = [
    ...
    {
        id: 2,
        image: "https://www.thebalancesmb.com/thmb/HCk--ysUcmvGXuMp5gtRdfbhK9s=/800x780/filters:no_upscale():max_bytes(150000):strip_icc()/Adobe_illustrator-c95bd1da899349bca8ea9cf4df937d1e.jpg",
    ...
    {
        id: 4,
        image: "https://www.saashub.com/images/app/service_logos/125/jyd3pirbz4w1/large.png?1579340184",
        title: "Web Developer",
        software: "Invision",
        Location: "London, UK",
        timePosted: 11,
    ...
    {
        id: 5,
        image: "https://logowik.com/content/uploads/images/upwork-icon.jpg",
        title: "Software Product Designer",
        software: "Invision",
        Location: "London, UK",
        timePosted: 11,
        salary: "$35k - $45k",
        ...
        <div className='p-12 grid grid-cols-4 lg:gap-16 lg:grid-cols-none lg:grid-rows-2'>
            ...
            <div className="col-span-3 lg:col-auto gap-4 grid pr-12 lg:p-0">
                ...
                <div className=' border border-gray-100 rounded-xl'>
                    {jobs.map(job => {
                        return (
                            <div className='flex border-b p-4  gap-4 items-center '>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className="p-4 flex flex-col justify-center gap-2 items-center border border-gray-100">

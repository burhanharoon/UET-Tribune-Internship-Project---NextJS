...
const Testimonials = () => {
    return (
        <div className='font-light testimonial sm:h-screen text-white p-16 pl-12 pr-12 sm:pl-6 sm:pr-6 flex items-center justify-center'>
            <div className='lg:w-full flex items-center justify-center gap-12 flex-col w-6/12 '>
                ...
                <div className='flex gap-4 text-center items-center justify-center flex-col'>
                    ...
                    <p className=''>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil adipisci, dolores explicabo vel quisquam, eum eaque minus repudiandae, illo libero assumenda accusantium harum! Nihil nulla veniam labore ut rerum cumque.</p>
                </div>
                <div className='flex gap-2 text-center items-center justify-center flex-col'>

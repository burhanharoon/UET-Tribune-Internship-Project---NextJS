        ...
        <div className='grid grid-cols-2 p-12 lg:grid-cols-none gap-12 border-b-2 border-gray-100'>
            ...
            <div className='flex flex-col gap-4 justify-center'>
                ...
                <div className='flex flex-col gap-4'>
                    <div className='shadow border-t-2 border-r-2 border-b-2 border-gray-100 rounded-xl'>
                        <div className='flex border-l-2 hover:rounded border-gray-50 hover:border-red-600 sm:hover:border-gray-100 hover:bg-blue-50 sm:hover:bg-transparent p-4 gap-4 items-center'>
